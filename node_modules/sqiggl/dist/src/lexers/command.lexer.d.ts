 ...
 * @internal
 */
export declare class CommandLexer {
    private options;
    private actions;
    private expressions;
     ...
     */
    constructor(options: LexerOptions, actions: Action[], expressions: Expression[], conjunctions: Conjunction[]);
    /**
     ...
     * @returns {DSLCommand}
     */
    invoke(input: string, parts: string[]): DSLCommand;
    /**
     ...
     * @returns {DSLCommand}
     */
    private generateCommandDSL(definition, value);
    /**
